...
class LivePortraitWrapper(object):
    ...
    def __init__(self, inference_cfg: InferenceConfig):
        ...
        if self.compile:
            ...
            self.warping_module = torch.compile(self.warping_module, mode='max-autotune-no-cudagraphs')
            self.spade_generator = torch.compile(self.spade_generator, mode='max-autotune-no-cudagraphs')
